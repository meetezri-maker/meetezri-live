        ...
        {showResolveModal && selectedEvent && (
          ...
          >
            <motion.div
              ...
              onClick={(e) => e.stopPropagation()}
              className="w-full max-w-xl p-6 rounded-3xl border border-white/10 bg-[#0b0d14] shadow-2xl shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] border border-pink-100"
            >
