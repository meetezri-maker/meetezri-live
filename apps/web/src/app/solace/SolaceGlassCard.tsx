...
export function SolaceGlassCard({ children, className, ...rest }: SolaceGlassCardProps) {
  return (
    <div
      className={cn(
        "solace-glass-card relative overflow-hidden rounded-[28px] border border-[color:var(--solace-ds-border-glow)] bg-[var(--solace-ds-surface)] text-[var(--solace-ds-text)] backdrop-blur-xl",
