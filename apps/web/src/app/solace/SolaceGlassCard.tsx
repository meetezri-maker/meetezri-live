...
export function SolaceGlassCard({ children, className, ...rest }: SolaceGlassCardProps) {
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-[28px] border border-[color:var(--solace-ds-border-glow)] bg-[var(--solace-ds-surface)] text-[var(--solace-ds-text)] backdrop-blur-xl",
        "shadow-[0_0_0_1px_rgba(168,85,247,0.12),0_0_48px_-20px_var(--solace-ds-glow-purple),0_40px_100px_-48px_rgba(0,0,0,0.85),inset_0_1px_0_rgba(255,255,255,0.06)]",
