    ...
    >
      {backgroundSrc ? (
        <img
          src={backgroundSrc}
          alt=""
          className="shaz absolute inset-0 h-full w-full object-cover object-center opacity-75"
          loading="eager"
          decoding="async"
        />
      ) : null}
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_100%_50%_at_50%_100%,rgba(8, 15, 28, 0.16)_0%,transparent_55%)]" />
      <div className="absolute bottom-0 left-0 right-0 h-[45%] bg-[linear-gradient(180deg,transparent_0%,rgba(0, 0, 0, 0.09)_100%)]" />
      <div
