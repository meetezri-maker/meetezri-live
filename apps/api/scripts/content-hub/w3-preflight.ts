/**
 * Week 3 import preflight — READ ONLY.
 *
 * Confirms the target is the same live Supabase project Week 1 was imported into, reads the three
 * Week 1 records back untouched, and proves the three Week 3 editorial refs and their proposed
...
const W2_REFS = ['W3-A001', 'W3-G001', 'W3-B001'];
const W2_SLUGS = [
